    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row w-100" style="margin-left: 12px;">
                <div class="d-flex" style="flex-direction: row;">
                    <p
                        style="margin: 0; font-family: Nunito; font-size: 20px; font-weight: 700; line-height: 28px; text-align: left; color: #38B2AC;">
                        Working</p>
                    <div class="vr" style="margin-left: 11px; margin-right: 11px;"></div>
                    <nav class="br-nav" style="--bs-breadcrumb-divider: '>'; padding-bottom: 0;"
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-white text-center rounded"
                style="border: 1px solid #CBD5E0; box-shadow: 0px 0px 2px 0px #00000033; box-shadow: 0px 2px 10px 0px #0000001A;">
                ...
                <div class="d-flex px-3 pt-3" style="flex-direction: column">
                    <div class="row w-100">
                        <div class="col d-flex" style="flex-direction: ">
                ...
                <ul class="nav nav-underline nav-fill nav-justified px-3 " style="--bs-nav-underline-gap: 0rem; --bs-nav-underline-link-active-color:#319795 ">
                    <li class="nav-item">
